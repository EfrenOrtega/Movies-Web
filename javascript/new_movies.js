...
export default function newMovies(){
    ...
    fetch('https://api.themoviedb.org/3/movie/now_playing?api_key=9442d5549eb42ed94e41b7f7e58bdace')
    ...
    .then(json=>{
        ...
        document.getElementById('new-movies').querySelector('.movies').appendChild($fragment)
